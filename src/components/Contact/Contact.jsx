  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold text-sky-900 mb-4">
            {t('contact.title')}
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <form className="space-y-6">
              ...
              <div>
                <label htmlFor="subject" className="block text-sm font-medium text-sky-700 mb-1">
                ...
                >
                  ...
                  <option value="membership">{t('contact.form.options.membership')}</option>
                  <option value="media">{t('contact.form.options.media')}</option>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-sky-100">
                    {t('contact.info.phoneMain')}
                  </p>
                  <p className="text-sky-100">
                    {t('contact.info.phoneTickets')}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-sky-100">
                    {t('contact.info.emailMain')}
                  </p>
                  <p className="text-sky-100">
                    {t('contact.info.emailTickets')}
                  </p>
                </div>
              </div>
